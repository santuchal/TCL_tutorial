...
proc apple_sharing {apple student} \
{
	set divided [expr $apple/$student]
	set reminder [expr $apple%$student]
	return $divided$reminder
}

set apple [gets stdin]
set student [gets stdin]

puts [apple_sharing $apple $student]